...
def build_cnn_v2(input_shape=(48, 48, 1), num_classes=7):
    ...
    model = tf.keras.Model(inputs, outputs, name="cnn_v2_bn")
...
def main():
    ...
    print("[INFO] Model oluşturuluyor (CNN V2 + BatchNorm)...")
    model = build_cnn_v2(input_shape=(IMG_H, IMG_W, 1), num_classes=NUM_CLASSES)

    os.makedirs(MODEL_DIR, exist_ok=True)

    ckpt_path = os.path.join(MODEL_DIR, "cnn_v2_best.h5")
    callbacks = [
    ...
    final_path = os.path.join(MODEL_DIR, "cnn_v2_final.h5")
